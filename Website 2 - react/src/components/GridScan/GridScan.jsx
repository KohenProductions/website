...
export const GridScan = ({
    ...
    const tiltTarget = useRef(0); const tiltCurrent = useRef(0); const tiltVel = useRef(0);
    const yawTarget = useRef(0); const yawCurrent = useRef(0); const yawVel = useRef(0);
    ...
    useEffect(() => {
        ...
        return () => { el.removeEventListener('mousemove', onMove); el.removeEventListener('mouseleave', onLeave); if (leaveTimer) clearTimeout(leaveTimer); };
    }, []);
    ...
    useEffect(() => {
        ...
        const uniforms = {
            ...
            uLineStyle: { value: 0 }, uLineJitter: { value: 0 },
